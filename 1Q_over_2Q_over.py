...
def main_checks(data, team1_input = 1, team2_input= 1, desired = 1, k = 1, ind = 1) -> list[list, int, int]:
    ...
    for game in data:
        try:
            ...
            fora1 = abs(t1q1 - t2q1)
            fora2 = abs(t1q1 - t2q2)
            fora1half = abs(t1q1 + t1q2 - t2q1 - t2q2)
        except:
            continue
        ...
        if  k1 < 2.5:
            ...
            if  t1q1 > team1_input and t2q1 > team2_input and t1q2 > team1_input and t2q2 > team2_input and fora1half > ind:
                cases_h += 1
                if t2q3 >  desired :
                    positive_h += 1
                else:
    ...
    print()
    print('HOME FOCUS', 'CONFIG:',f'K:{k}, 1Q(UNDER inc.):{team1_input} - {team2_input}, BET 3Q UNDERDOG OVER:{desired}')
...
main_checks(clear_results, team1_input=25, team2_input=16, desired=18, k=1.7, ind=8) # k = 1.7
