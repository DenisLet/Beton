...
def main_checks(data, team1_input = 1, team2_input= 1, desired = 1, k = 1) -> list[list, int, int]:
    ...
    print('HOME(2 case) TEAM WIN 3Q WHEN UNDERDOG')
    ...
    print('------------------')
    print('AWAY(1 case) TEAM WIN 3Q WHEN UNDERDOG')
...
main_checks(clear_results, team1_input = 25 , team2_input = 15 ,desired= 1,k = 2.6) # k = 1.7
