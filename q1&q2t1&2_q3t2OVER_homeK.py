...
def main_checks(data, q1_in = 1, min = 1, max = 1, desired = 1, k = 1) -> list[list, int, int]:
    ...
    for game in data:
        ...
        if  k1:
            ...
            if t1q1 > q1_in and min<t2q1<max and t1q2 > q1_in and min<t2q2 <max:
                cases += 1
...
data = [5, 10]
main_checks(clear_results, q1_in = 21 , min =5, max= 21   ,desired= 16,k = 1.7) # k = 1.7
